...
| Code | Primary exclusion reason | Records |
|---|---|---:|
...
Each excluded record received one primary code so that the aggregate categories were mutually exclusive and reconciled with the 513 records excluded from the final synthesis.
